...
public class NBStructure {
    ...
    private int tcpPayLoadLen;

    private String wireSharkTs;
    ...
    public int getTcpPayLoadLen() {
        return tcpPayLoadLen;
    }

    public void setTcpPayLoadLen(int tcpPayLoadLen) {
        this.tcpPayLoadLen = tcpPayLoadLen;
    }
    ...
    public NBStructure(String tS, long seqMess, long ackMess, String src, String des, int id, int checkSum, int totalLength, int identify) {
    ...
    public String getWireSharkTs() {
        return wireSharkTs;
    }

    public void setWireSharkTs(String wireSharkTs) {
        this.wireSharkTs = wireSharkTs;
    }
