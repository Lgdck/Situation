...
abstract public class Comm implements CommIF {
	...
	// Size of the buffer used for reading/writing from/to connections 
	protected static final int MIN_BUFFER_SIZE = 128 * 1024; //(32KB)32 * 1024;
	
	// Maximum buffer size of 
	protected static final int MAX_BUFFER_SIZE = 1024 * 1024 * 1024; // 1 * 1024 * 1024;1 MB
	...
	protected abstract AcceptConnHandler getAcceptConnHandler(AddressIF localAddress, CB0 cbHandler);
...
//			System.out.println(channel+"----"+remoteAddr);  //输出的是3次握手过程
